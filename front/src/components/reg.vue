<template>
  <div>
    ...
    <van-cell-group>
        ...
        <van-field label="再次输入密码" v-model="password1"  type="password" />
        ...
        <van-button color="gray" @click="reg"> 点击注册 </van-button>
 ...
 data() {
  ...
  methods:{
    ...
    reg:function(){
          ...
          this.myaxios("https://localhost/user/","post",{"username":this.username,"password":this.password,"type":this.type}).then(data =>{
